...
# Create dummy user
User1 = User(name="The Goat", email="the_goat@gamai.com",
             picture_url='https://www.creativefabrica.com/wp-content/uploads/2020/11/07/Goat-Face-Logo-Design-Template-Graphics-6501894-1.jpg')
...
print ("Los Items han sido agregados con exito!!")
